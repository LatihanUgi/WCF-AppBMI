...
<head>
    ...
    <title>Artikel | Hidup Sehat Dot Com</title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Post Content -->
				<?php
				$url = "http://localhost/ProjectWCF/User.svc/GetAllArtikel";
				$json = file_get_contents($url);
				$obj = json_decode($json,TRUE);
				foreach($obj['GetAllArtikelResult'] as $page) {
					?>
                <!-- Preview Image -->
                ...
                <p class="lead"><?php echo $page['Judul']; ?></p>

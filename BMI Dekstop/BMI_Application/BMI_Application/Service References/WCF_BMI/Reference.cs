...
namespace BMI_Application.WCF_BMI {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="WCF_BMI.IService")]
    public interface IService {
        ...
        void UpdateUser(string username, string password, string fullname, string dob, string gender, string phone, string email, string doj);
        ...
        void UpdateRecord(string id, string username, string fullname, string gender, string height, string weight, string status, string date);
        ...
        void AddAdmin(string id, string admin, string password);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceChannel : BMI_Application.WCF_BMI.IService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceClient : System.ServiceModel.ClientBase<BMI_Application.WCF_BMI.IService>, BMI_Application.WCF_BMI.IService {
        ...
        public void UpdateUser(string username, string password, string fullname, string dob, string gender, string phone, string email, string doj) {
            base.Channel.UpdateUser(username, password, fullname, dob, gender, phone, email, doj);
        }
        ...
        public void UpdateRecord(string id, string username, string fullname, string gender, string height, string weight, string status, string date) {
            base.Channel.UpdateRecord(id, username, fullname, gender, height, weight, status, date);
        }
        ...
        public void AddAdmin(string id, string admin, string password) {
            base.Channel.AddAdmin(id, admin, password);
        }
    }
}

...
public class TipsDetail extends Activity {
    ...
    // single event url
    private static final String url_details = "http://sahabatjam5.cloudapp.net/ProjectWCF/User.svc/GetArtikel/Detail/";
                ...
                if (json.length() > 0) {
                    ...
                    try {
                        ...
                        html = "<body'><h2 style='color:#fffccc;'>"
                                ...
                                + "</h2>"
                                + "<img src='http://sahabatjam5.cloudapp.net/ProjectWCFWeb/photoartikel/"
